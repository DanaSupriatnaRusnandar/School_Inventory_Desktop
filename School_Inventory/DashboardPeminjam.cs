...
namespace School_Inventory
{
    public partial class DashboardPeminjam : Form
    {
        ...
        private void btn_Kelas_Click_1(object sender, EventArgs e)
        {
            activateButton(sender, RGBColor.color2);
        }

        private void btn_Peminjaman_Click_1(object sender, EventArgs e)
        {
            activateButton(sender, RGBColor.color3);
        }

        private void btn_Pengembalian_Click_1(object sender, EventArgs e)
        {
